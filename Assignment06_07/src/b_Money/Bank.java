...
public class Bank {
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			//changed from accountlist.get(params) to accountlist.get(params)
		}
	}
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) { //Added to the condition because it was thrown even when the account existed
	 ...
	 */
	public void tick(){ //removed throws Exception
